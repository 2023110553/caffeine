...
import { getMonthlySummary, getDeductionBreakdown, approveMonthlyClose } from "../../api/analytics";
...
function DashboardPage() {
  ...
  // TODO: 백엔드 구현 완료되면 아래 주석 해제하고 위 mock state 초기값을 null로 되돌리기
  ...
  const handleApprove = async () => {
    setIsApproving(true);
    try {
      await approveMonthlyClose(YEAR, MONTH);
      setIsClosed(true);
    } catch (err) {
